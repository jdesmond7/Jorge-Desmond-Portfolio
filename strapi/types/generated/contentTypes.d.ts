...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reportCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutTeaser: Schema.Attribute.Text;
    aboutTitle: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    heroName: Schema.Attribute.Text;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stackItems: Schema.Attribute.Component<'shared.stack-item', true>;
...
export interface ApiIlustracionIlustracion extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ilustracion.ilustracion': ApiIlustracionIlustracion;
